            ...
            <div class="content">
                ...
                <div class='_c'>
                    ...
                    <div class='bitcoin'>
                        ...
                        <span>` + Math.floor((parseInt(e.minNormalPrice) - parseInt(e.couponDiscount)) * parseInt(e.promotionRate) / 1000) + `</span>
                    </div>
                    <div class='domi'>
                        <img src="./image/domi.png" alt="">
                        <span>` + Math.floor(((parseInt(e.minNormalPrice) - parseInt(e.couponDiscount)) - ((parseInt(e.minNormalPrice) - parseInt(e.couponDiscount)) * parseInt(e.promotionRate) / 1000))) + `</span>
                    </div>
                </div>
                <div class='_b'>
                    <div>
                    ...
                    data-bitcoin =` + (parseInt(e.minNormalPrice) - parseInt(e.couponDiscount)) * parseInt(e.promotionRate) / 1000 + ` 
                    data-domi =` + ((parseInt(e.minNormalPrice) - parseInt(e.couponDiscount)) - ((parseInt(e.minNormalPrice) - parseInt(e.couponDiscount)) * parseInt(e.promotionRate) / 1000)) + ` 
