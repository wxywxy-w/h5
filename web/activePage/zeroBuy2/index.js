        ...
        _html +=
            ...
            <div class="content">
                ...
                <div class='_b'>
                    ...
                    <button  onclick='getTicket(` + e.goodsId + `,`+e.promotionRate+`)' 
                    data-activeId = ` + _id + ` 
                    ...
                    class='` + setactiveclass(st, et,e.promotionRate) + ` pullDown ' >
                        ` +
            isButtonStayActive(st, et,e.promotionRate) +
            `
                    </button>
                </div>
            </div>
...
function isButtonStayActive(i, j,p) {
    let
        str = '',
        t = new Date().getTime()
    if (i < t && t < j) {
